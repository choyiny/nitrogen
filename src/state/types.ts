...
export type BackdropId = "transparent" | "slate" | "coral" | "indigo" | "black";
export type AspectId = "auto" | "16:9" | "square" | "twitter" | "linkedin";
...
export const BLOCK_TYPES: BlockType[] = ["userPrompt", "assistant", "bash", "edit", "read", "bare"];
...
export function newBlock(type: BlockType, id: string): Block {
  switch (type) {
    ...
    case "bash":
      return { id, type, command: "", output: "" };
    case "edit":
      return { id, type, filepath: "", lines: [] };
    case "read":
      return { id, type, filepath: "", summary: "" };
    case "bare":
      return { id, type, text: "" };
  }
}
