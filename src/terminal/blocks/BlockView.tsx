  ...
  switch (block.type) {
    ...
    case "bash":
      return (
        <div style={{ margin: "10px 0" }}>
          <div>
            <Bullet /> <span style={{ color: c.text }}>{t.toolLabels.bash}</span>(
            <span style={{ color: c.context }}>{block.command}</span>)
          </div>
    ...
    case "edit":
      return (
        <div style={{ margin: "10px 0" }}>
          <div>
            <Bullet /> <span style={{ color: c.text }}>{t.toolLabels.edit}</span>(
            <span style={{ color: c.context }}>{block.filepath}</span>)
          </div>
    ...
    case "read":
      return (
        <div style={{ margin: "10px 0" }}>
          <div>
            <Bullet /> <span style={{ color: c.text }}>{t.toolLabels.read}</span>(
            <span style={{ color: c.context }}>{block.filepath}</span>)
          </div>
